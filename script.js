...
if(test === "hemoglobin"){
    if(value < 12){
        result = "Your hemoglobin appears low. This may suggest anemia.";
    }
    else if(value <= 16){
        result = "Your hemoglobin is within the normal range.";
    }
    else{
        result = "Your hemoglobin appears high.";
    }
}
else if(test === "glucose"){
    if(value < 70){
        result = "Your blood glucose seems low.";
    }
    else if(value <= 100){
        result = "Your glucose level appears normal.";
    }
    else{
        result = "Your glucose level is elevated.";
    }
}
else{
    result = "This test is not yet in the database.";
}
